...
class Servidor(Pessoa, Endereco, Contato):
    ...
    def setServidor(self, nome=None, idade=None, sexo=None, cpf=None, cidade=None, bairro=None,
                 rua=None, numero=None, telefone=None, email=None, matricula=None):
        if nome is not None:
            self.nome = nome
